...
class List1 extends LL{
	int j;
	boolean k;
	List2 ls;
	public int Start(){return 1;}
	public int Hey2(List2 j, int k, int l){return 2;}
}

class List2 extends List1{
	int j;
	public int test2(int j){ return 0; }
}

class List6 extends List2{
	int k;
}

class List4 extends List2{
	boolean j;
}

class List5 extends List4{
	public int Start(){return 1;}
}
